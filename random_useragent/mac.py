...
class Mac(Chrome):
    ...
    def generate_mac_ua(self) -> str:
        d = random.choice(
            [self.generate_mac_chrome_ua, self.generate_mac_firefox_ua, self.generate_mac_safari_ua])
        return d()
